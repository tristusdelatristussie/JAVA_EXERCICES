...
public class Etudiants extends JFrame implements ActionListener {
	...
	public Etudiants() {
		...
		table = new JTable(new DefaultTableModel(null, new Object[] {"nom","prenom","tel"}));
		...
		table.setBounds(10,150,800,500);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == buttonSup) {
			...
			if( x == -1) {
			JOptionPane.showMessageDialog( null, "Erreur ligne vide");
